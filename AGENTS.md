...
This project is indexed by GitNexus as **docker-infra-stack** (4 symbols, 2 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/docker-infra-stack/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/docker-infra-stack/context` | Codebase overview, check index freshness |
| `gitnexus://repo/docker-infra-stack/clusters` | All functional areas |
| `gitnexus://repo/docker-infra-stack/processes` | All execution flows |
| `gitnexus://repo/docker-infra-stack/process/{name}` | Step-by-step execution trace |
...
5. If infrastructure, tooling, or services changed, the root overview documents were reviewed and updated in the same change
